...
public class UsePredicate {
    public static void main(String[] args) {
        ...
        System.out.println(FunctionsUtil.isPalindrome.test("anna"));
        System.out.println(FunctionsUtil.isPalindrome.test("camp"));

        System.out.println("-------------------------------------------");
        System.out.println(FunctionsUtil.isPrime.test(7));
        boolean is11Prime = FunctionsUtil.isPrime.test(11);
